        ...
        <>
          ...
          <div className="flex flex-col items-center" style={{ marginTop: 20 * view.zoom }}>
            ...
            {view.streamerMode ? (
              ...
              <div className="flex items-center justify-center gap-3" style={{ marginTop: 12 * view.zoom }}>
                <div
                ...
                {/* No confirmation, unlike the Reset beside the real Save
                    button: that one destroys saved predictions, this one
                    clears a scratch board between guests and is meant to
                    be hit on air without a dialog in the way. */}
                <button
                  type="button"
                  onClick={() => {
                    resetPicks();
